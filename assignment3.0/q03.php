...
//now print out each record
    $columns = 4;
    $query = 'SELECT DISTINCT tblSections.fldDays, tblCourses.fldCourseName, tblSections.fldStart, tblSections.fldStop 
                FROM tblSections 
                ...
                AND tblTeachers.fldFirstName = "Jackie Lynn" 
    ...
    print '<tr><th>Days</th><th>Course Name</th><th>Start Time</th><th>Stop Time</th></tr>';
