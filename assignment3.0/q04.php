...
//now print out each record
    $columns = 3;
    $query = 'SELECT DISTINCT tblSections.fldCRN, tblStudents.fldLastName, tblStudents.fldFirstName '
            . 'FROM tblSections '
            . 'INNER JOIN tblEnrolls '
            . 'ON tblSections.fnkCourseId = tblEnrolls.fnkCourseId '
            . 'INNER JOIN tblStudents '
            . 'ON tblEnrolls.fnkStudentId = tblStudents.pmkStudentId '
            . 'WHERE tblSections.fldCRN = "91954" '
            . 'ORDER BY tblSections.fldCRN, tblStudents.fldLastName, tblStudents.fldFirstName';
   ...
   // $testquery = $thisDatabaseReader->select($query, "", 0, 0, 0, 0, false, false);
    ...
    print '<tr><th>CRN</th><th>Last Name</th><th>First Name</th></tr>';
