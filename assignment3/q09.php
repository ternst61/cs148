...
//now print out each record
    $columns = 2;
    $query = 'SELECT DISTINCT fldBuilding, COUNT(DISTINCT fldNumStudents) FROM tblSections WHERE fldDays LIKE "%W%" GROUP BY fldBuilding ORDER BY count(DISTINCT fldNumStudents) DESC';
